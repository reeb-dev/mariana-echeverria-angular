  ...
  return (
    ...
    >
      <Image
        ...
        sizes="100vw"
      />
      <div className="absolute inset-0 bg-gradient-to-t from-forest-deep/95 via-forest-deep/55 to-forest-deep/25" />
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,oklch(0.78_0.035_85_/_0.2),transparent_55%)]" />

      <div className="relative z-10 mx-auto w-full max-w-6xl px-5 pb-16 pt-28 md:px-8 md:pb-24">
        <p
          className="animate-hero-rise font-display text-5xl leading-[0.95] tracking-tight text-white sm:text-6xl md:text-7xl lg:text-8xl"
        ...
        >
          Corredora, tasadora y martillera pública. Venta, alquiler y
          desarrollos en Zona Norte, CABA y Coronel Suárez.
        </p>
        <div
